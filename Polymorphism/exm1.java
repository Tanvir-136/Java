...
//     public void setPepperoniToppings(int noOFPepperoniToppings) {
//         this.noOFPepperoniToppings = noOFPepperoniToppings;
//     }
...
//     public String getDescription() {
//         return "Pizza{" + "Size= " + size + "\"" + ",Cheese Toppings= " + noOFCheeseToppings + ",Pepperoni Toppings = " + noOFPepperoniToppings + ",Ham Toppings= " + noOfHamToppings + ",Cost= " + calcCost() + '}';
//     }
// }
